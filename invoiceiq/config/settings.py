...
# --- Product Branding ---
PRODUCT_NAME = "InvoiceIQ Processing Suite"
PRODUCT_SHORT_NAME = "InvoiceIQ"
PRODUCT_ICON = "🧭"

# --- Invoice Health Settings ---
INVOICE_RISK_WEIGHT = 1.0
INVOICE_PENDING_WEIGHT = 0.6
INVOICE_REJECTION_WEIGHT = 1.2
